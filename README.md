...
Steps:
	...
	•	Kubernetes pods (kubectl get pods -n jenkins -w)
...
2.How did you test repoC python?
	...
	•	While the pipeline running, exec into the pod and cd according these path cd /home/jenkins/agent/workspace/PipelineC
	•	Verified the log content using cat doxygen_warnings.log
